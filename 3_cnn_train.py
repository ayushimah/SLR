...
def one_hot_targets_(labels_dense,nb_classes):
    ...
    print(targets)
    one_hot_targets = np.eye(nb_classes)[targets] #returns an array of shape, R x C, where all elements are equal to zero, except for the kth diagonal, whose values are equal to one.
